...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql1 = "SELECT unitno FROM house_info WHERE unitno='$fullname' AND username='$username1'";
  $result1 = $conn->query($sql1);

  if ($result1->num_rows > 0) {
      echo "<script>alert('Unit name already exists'); window.location.href='http://localhost/Bari-Wala/Owner/Owner-Dashboard/Check/index.php';</script>";
  } else {
  ...
  <div class="content"> 
   ...
   <form action="index.php" method="post" class="form">
    ...
    <div class="inputBox"> 
     ...
     <input type="text"id="UName"name="rent" required > <i>Set Rent</i> 
